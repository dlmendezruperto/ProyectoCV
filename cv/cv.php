  ...
  <body data-home-page="PLANTILLA2.html" data-home-page-title="PLANTILLA2" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="es">
    <section class="u-clearfix u-section-1" id="cvp2">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-left u-shape u-shape-rectangle u-white u-shape-2"></div>
    ...
    <img class="u-image u-image-circle u-image-1" id="displayImage" src="data:image/jpg;base64,<?php echo base64_encode($row['foto'])?>">
        ...
        <p class="u-text u-text-body-alt-color u-text-2"><span class="u-file-icon u-icon u-text-white"><img src="images/542689-77495b6b.png" alt=""></span>&nbsp;<?php printf($row["correo"]); ?>
        </p>
        <p class="u-text u-text-body-alt-color u-text-3"><span class="u-file-icon u-icon u-text-white"><img src="images/25694-4d0e97fe.png" alt=""></span>&nbsp;<?php printf($row["direccion"]); ?>
        </p>
        <h4 class="u-text u-text-body-alt-color u-text-default u-text-4">Idiomas</h4>
        <ul class="u-text u-text-white u-text-5">
          <li><?php printf($row["idioma1"]); ?></li>
          <li><?php printf($row["idioma2"]); ?></li>
          <li><?php printf($row["idioma3"]); ?></li>
        </ul>
        <div class="u-container-align-center u-container-style u-custom-color-3 u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h5 class="u-align-center u-text u-text-default u-text-6">PERFIL </h5>
          </div>
        </div>
        <p class="u-large-text u-text u-text-variant u-text-7"><?php printf($row["aptitudes"]); ?></p>
        <div class="u-container-align-center u-container-style u-custom-color-3 u-group u-shape-rectangle u-group-2">
          <div class="u-container-layout u-container-layout-2">
            <h5 class="u-align-center u-text u-text-default u-text-8">FORMACION </h5>
          </div>
        </div>
        <p class="u-large-text u-text u-text-variant u-text-9">
          <span style="font-weight: 700;"><?php printf($row["carrera"]); ?></span>
          <br><?php printf($row["universidad"]); ?><br>2026-05-21
        </p>
        <div class="u-container-align-center u-container-style u-custom-color-3 u-group u-shape-rectangle u-group-3">
          <div class="u-container-layout u-container-layout-3">
            <h5 class="u-align-center u-text u-text-default u-text-10">CURSOS </h5>
          </div>
        </div>
        <p class="u-large-text u-text u-text-variant u-text-11"><?php printf($row["certificados"]); ?></p>
        <div class="u-container-align-center u-container-style u-custom-color-3 u-group u-shape-rectangle u-group-4">
          <div class="u-container-layout u-valign-middle u-container-layout-4">
            <h5 class="u-align-center u-text u-text-default u-text-12">EXPERIENCIA </h5>
          </div>
        </div>
        <p class="u-large-text u-text u-text-variant u-text-13"><?php printf($row["empresa1"]); ?><br><?php printf($row["duracion1"]); ?><br><?php printf($row["puesto1"]); ?><br><?php printf($row["descripcion1"]);?>
        </p>
        <p class="u-large-text u-text u-text-variant u-text-14"><?php printf($row["empresa2"]); ?><br><?php printf($row["duracion2"]); ?><br><?php printf($row["puesto2"]); ?><br><?php printf($row["descripcion2"]);?>
        </p>
        <p class="u-large-text u-text u-text-variant u-text-15"><?php printf($row["empresa3"]); ?><br><?php printf($row["duracion3"]); ?><br><?php printf($row["puesto3"]); ?><br><?php printf($row["descripcion3"]);?>
        </p>
      </div>
    </section>
