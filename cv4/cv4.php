...
if($numeroRegistros<=0) 
  ...
  <body data-home-page="PLANTILLA2.html" data-home-page-title="PLANTILLA2" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="es">
    <section class="u-clearfix u-section-1" id="sec-9d58">
      <br><br>
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-custom-color-4 u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h4 class="u-text u-text-3">Experiencia laboral </h4>
          </div>
        </div>
        <h6 class="u-align-center u-text u-text-black u-text-4">Contacto </h6>
        ...
        <p class="u-align-center u-text u-text-5"><span class="u-file-icon u-icon u-text-custom-color-1"><img src="images/347803-87a945be.png" alt=""></span>&nbsp;<?php printf($row["correo"]); ?>
        </p>
        <p class="u-align-center u-text u-text-default u-text-6"><span class="u-file-icon u-icon u-text-black"><img src="images/3449750-b55c6bbf.png" alt=""></span>&nbsp;&nbsp;<?php printf($row["linkedin"]); ?>
        </p>
        <p class="u-align-center u-text u-text-default u-text-7"><span class="u-file-icon u-icon u-text-black"><img src="images/447031-999d969d.png" alt=""></span>&nbsp;&nbsp;&nbsp;<?php printf($row["direccion"]); ?>
        </p>
        <p class="u-align-center u-text u-text-8"> <?php printf($row["empresa1"]); ?>&nbsp;<br><?php printf($row["duracion1"]); ?>&nbsp;<br><?php printf($row["puesto1"]); ?>&nbsp;<br><?php printf($row["descripcion1"]); ?>
        </p>
        <div class="u-container-style u-custom-color-4 u-group u-shape-rectangle u-group-2">
          <div class="u-container-layout u-container-layout-2">
            <h4 class="u-text u-text-9">Idiomas </h4>
          </div>
        </div>
        ...
        <p class="u-align-center u-text u-text-12"> <?php printf($row["empresa3"]); ?><br>&nbsp;<?php printf($row["duracion2"]); ?><br>&nbsp;<?php printf($row["puesto3"]); ?>&nbsp;<br><?php printf($row["descripcion3"]); ?>
        </p>
        <div class="u-container-style u-custom-color-4 u-group u-shape-rectangle u-group-3">
          <div class="u-container-layout u-container-layout-3">
            <h4 class="u-align-center u-text u-text-13">Competencias </h4>
          </div>
        </div>
        <p class="u-align-center u-text u-text-14"><?php printf($row["certificados"]); ?></p>
        <div class="u-container-style u-custom-color-4 u-group u-shape-rectangle u-group-4">
          <div class="u-container-layout u-container-layout-4">
            <h4 class="u-align-center u-text u-text-15">Educación </h4>
          </div>
        </div>
        <div class="u-container-style u-custom-color-4 u-group u-shape-rectangle u-group-5">
          <div class="u-container-layout u-container-layout-5">
            <h4 class="u-align-center u-text u-text-16"> A cerca de mi</h4>
          </div>
        </div>
